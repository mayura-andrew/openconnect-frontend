...
export const ChangePasswordSchema = z
  .object({
    newPassword: z.string().min(8, 'Minimum 8 characters').max(100, 'Maximum 100 characters'),
    confirmPassword: z.string().min(8, 'Minimum 8 characters').max(100, 'Maximum 100 characters'),
  })
