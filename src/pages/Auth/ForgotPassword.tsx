...
import SuccessMessage from '@/components/common/SuccessMessage.component'
        ...
        <div className="flex items-center justify-center gap-10 font-inter">
          <div className="w-[402px] max-w-sm p-4">
            ...
            <div className="gap-1 pb-10">
              ...
              <p className="text-zinc-400 text-lg font-semibold leading-7">Forgot password?</p>
            </div>

            <div className="flex flex-col items-start pt-10">
              <p className="text-base font-medium">It looks like you’ve forgotten your password.</p>
              <p className="text-neutral-500 font-inter text-sm font-normal leading-6">
                Enter your Email Address and we'll send you an email that will allow you to reset
                your password.
              </p>
            </div>
