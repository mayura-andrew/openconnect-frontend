  ...
  useEffect(() => {
    if (isError && error?.error?.email) {
      ...
      const isEmailExistsError =
        ...
        (Array.isArray(emailError) && emailError.some((msg) => msg.includes('already exists')))
        ...
        <div className="flex items-center justify-center gap-10 font-inter">
          <div className="w-full max-w-sm p-4">
            <div className="gap-1 pb-10">
              ...
              <p className="text-zinc-400 text-lg font-semibold leading-7">Create your account</p>
            </div>
