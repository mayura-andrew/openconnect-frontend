    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="space-y-4">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Add skills and interests that are relevant to your professional profile. These help
              others with similar interests connect with you.
            </p>
        ...
        <div className="flex justify-between">
          ...
          <Button type="submit" onClick={nextStep} className="flex items-center">
            Continue
