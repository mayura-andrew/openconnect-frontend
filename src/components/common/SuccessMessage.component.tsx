...
const SuccessMessage: React.FC<SuccessMessageModalProps> = ({
  ...
  const isAccountExists = type === 'accountExists' || title.toLowerCase().includes('already exists')
  const isPasswordReset =
    type === 'passwordReset' || title.toLowerCase().includes('check your email')
                ...
                >
                  ...
                  <div className="bg-purple-50 border-l-4 border-purple-400 p-4 mb-4 text-left">
                    ...
                    <p className="text-purple-600 text-sm mt-2">
                      <span className="font-medium">Note:</span> The link will expire after 45
                ...
                >
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4 text-left">
                    ...
                    <p className="text-blue-600 text-sm mt-2">
                      <span className="font-medium">Tip:</span> If you don't see the email, please
