                    ...
                    >
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription className="text-xs text-gray-500">
                                                {field.value
                                                    ? levelDescriptions[
                                                          field.value as keyof typeof levelDescriptions
                                                      ]
                                                    : ''}
                                            </FormDescription>
                                            <FormMessage className="text-red-600" />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription className="text-xs text-gray-500">
                                        Share your GitHub repository to help
                                        others learn from your code
                                    </FormDescription>
                                    <FormMessage className="text-red-600" />
                                </FormItem>
                            )}
                        ...
                        <div className="space-y-2">
                            ...
                            <FormDescription className="text-xs text-gray-500">
                                ...
                                project (e.g., React, Machine Learning)
                            </FormDescription>
                        </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription className="text-xs text-gray-500">
                                            Describe the most valuable lessons
                                            or insights gained from this project
                                        </FormDescription>
                                        <FormMessage className="text-red-600" />
                                    </FormItem>
                                )}
